  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios_rounded, color: Colors.black, size: 16,),
          onPressed: () {
            Get.back();
          },
        ),
        title: Text("Detail", style: TextStyle(color: Colors.black, fontSize: 15),),
      ),
          ...
          child: Column(
            children: [
              ...
              SizedBox(
                ...
                width: Get.width,
                child: imgList.length !=1 ? CarouselSlider(
